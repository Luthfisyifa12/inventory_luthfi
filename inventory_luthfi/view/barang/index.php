...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="container">
    <h1>Data Barang</h1>
    <a href="view_tambah.php" class="btn btn-primary"><i class="fa-solid fa-square-plus"></i>Tambah Barang</a>
            ...
            while($result=mysqli_fetch_assoc($query)){
                ?>
                  <tr>
                    ...
                    <a href="proses_hapus.php?id_barang=<?php echo $result['id_barang']?>" onclick="return confirm('kamu yakin gak?') " 
